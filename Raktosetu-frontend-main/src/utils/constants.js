...
// Production: VITE_API_BASE_URL=https://raktosetu-backend.onrender.com (set in Netlify env vars at build time)
// Local dev fallback: http://localhost:8000
const _rawApiBaseUrl = import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000';
export const API_BASE_URL = _rawApiBaseUrl.replace(/\/+$/, '');
